...
- [How to install anaconda](#how-to-install-anaconda)
  - [How to manage your packages](#how-to-manage-your-packages)
  - [Environment in Jupyter Notebook](#environment-in-jupyter-notebook)
  - [Python](#python)
- [TensorFlow Installation](#tensorflow-installation)
- [Next Steps](#next-steps)
  - [Intro to Python and Pandas](#intro-to-python-and-pandas)
  - [How to install Ubuntu 16.04](#how-to-install-ubuntu-1604)
...
A very concise and well-written [tutorial](http://duspviz.mit.edu/tutorials/python_pandas/) by MIT. A good starting point with Python basics.

## How to install Ubuntu 16.04

A step-by-step [tutorial](Tutorial-InstallUbuntu.md).